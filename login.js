...
export default class App extends Component {
  ...
  Register = () => {
    ...
    if (email.length === 0 || password.length === 0) {
      ...
      alert("Logging in...");
      this.props.navigation.navigate("Search"); // Navigate to the next screen after login
    }
  }
  ...
  render() {
    return (
      <ImageBackground
        source={require('./assets/vb.jpg')} // Adjust path to your background image
      ...
      >
        <View style={styles.container}>
          <View style={styles.logoContainer}>
            ...
            <Image
              source={require('./assets/vb44.png')} // Adjust path to your logo image
              style={styles.logo}
              resizeMode="contain"
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: 'black', // Pink color
